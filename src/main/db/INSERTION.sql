...
VALUES
('How do I search for available rooms?', 'Rooms can be found on the "Rooms" page, the link can be found in the navigation bar.', true, 1145),
('How do I find directions to the hotel?', 'We suggest looking up our hotel on services like Google Maps.', true, 1145),
('Do you offer any discounts?', 'No, there are currently no discounts being provided.', true, 1145),
...
('My payment for a booking is not going through', '', false, 1145),
('How do I view past bookings?', '', false, 1145),
('What is the maximum number of people for one room?', '', false, 1145);
